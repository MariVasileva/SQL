...
select avg (monthly_salary) as role_name
from employee_salary             
     full join salary on  salary.id = employee_salary.salary_id
     full join roles_employee on employee_salary.employee_id = roles_employee.employee_id
     join roles on roles_employee.role_id = roles.id
...
select sum (monthly_salary) as role_name
from employee_salary             
     full join salary on  salary.id = employee_salary.salary_id
     full join roles_employee on employee_salary.employee_id = roles_employee.employee_id
     join roles on roles_employee.role_id = roles.id
...
select min (monthly_salary) as role_name
from employee_salary             
     full join salary on  salary.id = employee_salary.salary_id
     full join roles_employee on employee_salary.employee_id = roles_employee.employee_id
     join roles on roles_employee.role_id = roles.id
...
select max (monthly_salary) as role_name
from employee_salary             
     full join salary on  salary.id = employee_salary.salary_id
     full join roles_employee on employee_salary.employee_id = roles_employee.employee_id
     join roles on roles_employee.role_id = roles.id
